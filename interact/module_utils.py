...
class ConvBlock2D(nn.Module):
    def __init__(self, inplanes, planes, kernel_size=3, padding=None, stride=1, dilation=1, norm=False, activation=None, pool=False, upsm=False):
        ...
        self.conv = nn.Conv2d(inplanes, planes, kernel_size=kernel_size,
                              stride=stride, padding=padding, dilation=dilation, bias=not norm)
...
class ConvBlock3D(nn.Module):
    def __init__(self, inplanes, planes, kernel_size=3, padding=None, stride=1, dilation=1, norm=False, activation=None, pool=False, upsm=False):
        ...
        padding = dilation * \
            (kernel_size - 1) // 2 if padding is None else padding
        self.conv = nn.Conv3d(inplanes, planes, kernel_size=kernel_size,
                              stride=stride, padding=padding, dilation=dilation, bias=not norm)
...
class ResBlock2D(nn.Module):
    def __init__(self, inplanes, planes, downsample=None, activation='relu', last_activation=True):
        ...
        self.activation2 = get_activation(
            activation) if last_activation else None
